...
class TestConfig(unittest.TestCase):
    ...
    def test_apple_ads_dashboard_identity_is_read_from_env(self):
        from config import (
    ...
    @patch.dict("config.os.environ", {"AB_TEST_ID": "test-123"}, clear=False)
    def test_ab_test_id_is_read_independently(self):
        from config import get_ab_test_id
